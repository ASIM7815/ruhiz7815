...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:hello@ruhiz.com", label: "Email" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="mt-4 text-sm text-muted-foreground max-w-xs">
                The global student collaboration platform. Build, learn, and
                grow together.
              </p>
        ...
        <div className="border-t py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} RUHIZ. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground">
